...
<body>
	...
	<div class="alert alert-success alert-dismissible fade show" role="alert" style="text-align:center;margin:auto;width:75%;">
               ...
               <input type="hidden" name="qte1" value="<?php echo $qte1 ?>"> 
						<?php foreach(DOA::get_apro_id($id1,$id_cli,$pro) as $result){
						?>
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<select class="custom-select2 form-control" name="four" style="width: 100%; height: 38px;">
											...
											<?php foreach(DOA::afficher_personne(0,0) as $result1){?>
								...
								<div class="modal-dialog modal-sm modal-dialog-centered">
									<div class="modal-content bg-warning">
										<div class="modal-body text-center">
											...
											<button  class="btn btn-dark"  name="save_apro">Ok</button>
										</div>
									</div>
								</div>
							</div>
