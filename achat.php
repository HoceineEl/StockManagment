	...
	<div class="alert alert-success alert-dismissible fade show" role="alert" style="text-align:center;margin:auto;width:75%;">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Gestion des Approvisionnements</h4>
							</div>
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-secondary dropdown-toggle" href="afficher_appro.php" role="button">
									Retour
								</a>
							</div>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Listes Des Achats</h4>
					...
					<form method="post" action="ajouter.php">
						...
						<div class="row">					
                                            ...
                                            <div class="form-group">
                                            <label></label>
											<button name="add_pannier" class="btn btn-secondary btn-lg btn-block"style="width:75%;margin:auto">Ajouter aux Approvisionnements</button>
											</div></div>
											</div>
...
foreach(DOA::get_pannier(1) as $result){
    ?>
    <tr>
        <td class="table-plus"><?php echo $result['id']?></td>
        <td><?php echo $result['intitule']?></td>
        <td><?php echo $result['qte']?></td>
        <td><img onclick="show(<?php echo $result['id']?>)"src="effacer.png" style="width: 30px; cursor:pointer" data-toggle="modal" data-target="#alert-modal"></img>
           </tr>
<?php }
?>						
							</tbody>
                        ...
                        <div class="col-md-6 col-sm-12">
                                ...
                                <input name="type" type="hidden" class="form-control" value="1">
						<select class="custom-select2 form-control" name="four" style="width: 100%; height: 38px;">
											<?php
											foreach(DOA::afficher_personne(0,0) as $result){?>
					...
					<div class="col-md-12 col-sm-12">
								<div class="form-group">
									<label></label>
											<button name="valider_apro" class="btn btn-success btn-lg btn-block" style="width:75%;margin:auto">Valider tous</button>
											</div></div></form><?php } ?>
				</div></div>
							...
							<div class="modal fade" id="alert-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
								<div class="modal-dialog modal-sm modal-dialog-centered">
									<div class="modal-content bg-danger text-white">
										<input type="text" name="id_ligne" id="deleted_line">
                                        <input name="type" type="hidden" class="form-control" value="1">
	...
	<script>
		function show(var1){
    //alert(var1)
   document.getElementById('deleted_line').value=var1;
}
