								...
								<div class="modal-dialog modal-lg modal-dialog-centered">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="myLargeModalLabel">Information du client</h4>
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input name="tele" type="number"min="0" class="form-control" required>
								</div>
							</div>
						</div>
						<div class="row">
...
<div  id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style=" padding-left: 15px;" aria-modal="true">
								<div class="modal-dialog modal-lg modal-dialog-centered">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="myLargeModalLabel">Modifier un client</h4>
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Telephone</label>
									<input name="tele" id="tele" type="number"min="0" class="form-control" required>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Adresse</label>
									<input name="adresse" id="adresse"type="text" class="form-control" required>
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
								...
								<div class="modal-dialog modal-sm modal-dialog-centered">
									<div class="modal-content bg-warning">
										<div class="modal-body text-center">
											...
											<button  class="btn btn-dark"  name="save_client">Ok</button>
										</div>
									</div>
								</div>
							</div>
					...
					</form>		<button style="margin-top:-10%"class="btn btn-outline-primary" class="btn-block" data-toggle="modal" data-target="#warning-modal">Enregistrer</button>
...
foreach(DOA::afficher_personne($var,1) as $result){
    ?>
    <tr>
